...
Tabled Values are *F* Statistics for the Given Criteria and
df<sub>EFFECT</sub> = 1
...
Single-Factor Design, df<sub>EFFECT</sub> = 2, α = .05, n = Sample Size
per Condition
...
Single-Factor Design, df<sub>EFFECT</sub> = 3, α = .05, n = Sample Size
per Condition
...
Single-Factor Design, df<sub>EFFECT</sub> = 2, α = .01, n = Sample Size
per Condition
...
Single-Factor Design, df<sub>EFFECT</sub> = 3, α = .01, n = Sample Size
per Condition
...
Tabled Values are HSD Statistics for the Given Probabilities and Degrees
of Freedom
...
Tabled Values are HSD Statistics for the Given Criteria and
df<sub>EFFECT</sub> = 1
