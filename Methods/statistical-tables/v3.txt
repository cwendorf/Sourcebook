...
Single-Factor Design, df~EFFECT~ = 2, α = .05, n = Sample Size per
Condition
...
Single-Factor Design, df~EFFECT~ = 3, α = .05, n = Sample Size per
Condition
...
Single-Factor Design, df~EFFECT~ = 2, α = .01, n = Sample Size per
Condition
...
Single-Factor Design, df~EFFECT~ = 3, α = .01, n = Sample Size per
Condition
...
Tabled Values are HSD Statistics for the Given Criteria and df~EFFECT~ =
1
