...
Chapter: Reporting Statistics]{.smallcaps}**
...
2.  For statistical significance tests, "include the obtained magnitude
...
===================================
  ...
  **Eta-Squared**                      To provide a standardized measure of an effect (defined as the relationship between two variables).                      *η^2^* = \_\_\_\_\_.                     Indicates the proportion of variance in the dependent variable accounted for by the independent variable.
  ...
  **One-Way ANOVA**                    To compare two or more sample means when the means are from a single-factor between-subjects design.                     *F(df~1~,df~2~) = \_\_\_, p = \_\_\_.*   A small probability is obtained when the statistic is sufficiently large, indicating that the set of means differ significantly from each other.
  ...
  **Factorial\                         To compare four or more groups defined by a multiple variables in a factorial research design.                                                                    
  ANOVA**                                                                                                                                                                                                
  ------------------------------------ ------------------------------------------------------------------------------------------------------------------------ ---------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------
...
Frequency Information: Though not often reported, simple summary
...
> A paired samples *t* test showed that, for the four people, the
...
In more complex examples -- such as those with multiple outcome
variables -- it is often preferred to place statistical information in
tables rather than in the text.
...
text, while also summarizing the post hoc tests.
  ...
  ----------- -- --------- ------ --------- ------ --------- -- ------ ------ -- ----------- ------------- ------ -- ------------
  Variable       *M*       *SD*             *M*    *SD*         *M*    *SD*      *F*(2, 6)   *p*           η^2^      
