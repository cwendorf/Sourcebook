...
| Eta-Squared | To provide a standardized measure of an effect (defined as the relationship between two variables). | *&#951* *eta*<sup>2</sup> = \_\_\_\_\_. | Indicates the proportion of variance in the dependent variable accounted for by the independent variable. |
