...
> The “Value” column lists all the actual scores in the entire data set. 
> 
> “f” (or Frequency) indicates the number of times that score exists. For example, the score of 4 was listed 2 times.  
>
> The “%” column provides the percentage of cases for each possible score. For example, of the 8 scores in the entire data set, the score of 4 was listed 2 times and 2/8 is 25.0%. 
> 
> “Cuml %” is the SUM of all percentages up to and including the row in question. For example, 62.5% of scores were 4 or less. Similarly, 37.5% were 3 or less.
...
> Similarly, a score of .75 is at the 25<sup>th</sup> percentile and a score of 6.50 is at the 75<sup>th</sup> percentile. Notice that, in some cases, the score values are non-integer interpolated values.
...
> The participants (*N* = 8) had a low *Mdn* Outcome score of 4.00 (*IQR* = 0.75 – 6.50).
