...
Descriptives Statistics: The statistics were obtained using the “Descriptives” procedure described elsewehere. Note that they are calculated separately for each variable.
