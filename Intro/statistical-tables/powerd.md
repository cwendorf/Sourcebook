...
## Statistical Tables | Power for Cohen&#39;s *d*

### Two-Tailed Probabilities (*p*) for a One-Sample Design (α = .05) Given Cohen’s d and Sample Size (n)
...
### Two-Tailed Probabilities (*p*) for a One-Sample Design (α = .01) Given Cohen’s d and Sample Size (n)
...
### Two-Tailed Probabilities (*p*) for a Dependent-Samples Design (α = .05) Given Cohen’s d and Sample Size (n)
...
### Two-Tailed Probabilities (*p*) for a Dependent-Samples Design (α = .01) Given Cohen’s d and Sample Size (n)
...
### Two-Tailed Probabilities (*p*) for a Two-Sample Design (α = .05) Given Cohen’s d and Sample Size (n)
...
### Two-Tailed Probabilities (*p*) for a Two-Sample Design (α = .01) Given Cohen’s d and Sample Size (n)
